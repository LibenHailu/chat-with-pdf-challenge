...
const features = [
  {
    ...
    description: "keep all your important PDF files securely stored and easily accessible at anytime anywhere.",
    icon: GlobeIcon
  },
  {
  ...
  },
  {
    ...
    description: "Our intelligent chatbot remembers pervious interactions, providing a seamless and generalized experience.",
    icon: BrainCogIcon
  },
  {
  ...
  {
    name: "Cloud Backup",
    description: "Rest assured knowing your documents are safely backed on the cloud, protected from loss or damage.",
    icon: ServerCogIcon
  },
  {
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br />
              Upload your document, and our chatbot will answer questions, summarize content, and answer all your Qs. Ideal for everyone, <span className="text-indigo-600">Chat with PDF</span>{" "}
